...
We can see the behavior of \verb|define| and variable reference at the Chez Scheme Read-Eval-Print Loop, or \emph{REPL}.  First we start Chez Scheme, and then define \verb|x| to be \verb|5|:
