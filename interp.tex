...
%% \section{Expressions, values, and statements}

%% [intro sentence goes here, about Scheme and expressions, values, and statements.  Can add footnote or parenthetical about how in miniKanren we will also have the notion of terms, which generalizes the notion of a value.]
...
%% The definition \verb|(define x 5)| is a statement.
